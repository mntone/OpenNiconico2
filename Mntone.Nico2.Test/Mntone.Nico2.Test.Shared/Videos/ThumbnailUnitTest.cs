...
namespace Mntone.Nico2.Test.Videos
{
	...
	public sealed class ThumbnailUnitTest
	{
		...
		public void Thumbnail_0不正なID()
		{
			...
			{
				ThumbnailClient.GetThumbnailDataAsync( new NiconicoContext( new NiconicoAuthenticationToken() ), "ssm9" ).GetAwaiter().GetResult();
			} );
		}
		...
		public void Thumbnail_2チャンネル動画データ()
		{
			...
			Assert.AreEqual( "so22734676", ret.ID );
